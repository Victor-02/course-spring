...
import com.course.spring.entities.Payment;
...
import com.course.spring.repositories.OrderItemRepository;
...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Payment pay1 = new Payment(null, Instant.parse("2019-06-20T20:38:07Z"), o1);
		o1.setPayment(pay1);
